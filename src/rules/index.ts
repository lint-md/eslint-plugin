...
export const Rules = {
  ...
  'no-empty-code': require('./no-args-rules/no-empty-code'),
  'no-empty-delete': require('./no-args-rules/no-empty-delete'),
  'no-empty-inlinecode': require('./no-args-rules/no-empty-inlinecode'),
  'no-empty-list': require('./no-args-rules/no-empty-list'),
  'no-empty-url': require('./no-args-rules/no-empty-url'),
  'no-fullwidth-number': require('./no-args-rules/no-fullwidth-number'),
  'no-multiple-space-blockquote': require('./no-args-rules/no-multiple-space-blockquote'),
  'no-space-in-emphasis': require('./no-args-rules/no-space-in-emphasis'),
  'no-space-in-inlinecode': require('./no-args-rules/no-space-in-inlinecode'),
  'no-space-in-link': require('./no-args-rules/no-space-in-link'),
